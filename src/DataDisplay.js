...
export default class DataDisplay extends React.Component {
  ...
  render() {
    return (<div id="parent">
      ...
      <div>
        <DataSegment value={this.props.dataString} clearDataArray={this.props.clearDataArray} updateDataArray={this.props.updateDataArray}/>
      </div>
      <div id="Registers">
        <Center>
          <h3>
      ...
      <div>
        <MemoryDisplay memoryOps={this.props.memoryOps} updateInputMem={this.props.updateInputMem}/>
      </div>
